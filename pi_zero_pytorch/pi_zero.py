...
class PiZero(Module):
    ...
    def __init__(
        ...
        rtc_guidance = None,                 # use the guidance proposed in https://arxiv.org/abs/2506.07339, which in term is inspired by training-free guidance paper, which in turn from pseudo-inverse paper.
